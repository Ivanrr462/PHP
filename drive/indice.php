...
$nombre_usuario = ($resultado->num_rows > 0) ? $resultado->fetch_assoc()['login'] : 'Usuario';
        ...
        <table>
            ...
            foreach ($contenido as $elemento) {
                if ($elemento != "." && $elemento != "..") {
                    ...
                    echo "<a href='#' onclick='openFile(\"$archivo_path\")'><img src='./imagenes/ver.png' width='25' alt='Ver'></a>";
                    echo "</td>";
                    echo "</tr>";
                }
            }
